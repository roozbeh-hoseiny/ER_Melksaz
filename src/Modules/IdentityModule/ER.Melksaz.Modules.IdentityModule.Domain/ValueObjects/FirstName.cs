...
public readonly partial record struct FirstName
{
    ...
    public static readonly FirstName Empty = new(string.Empty);
    ...
    public static PrimitiveResult<FirstName> Create(string value)
    {
        ...
        if (validationResult.IsFailure)
            return PrimitiveResult.Failure<FirstName>(validationResult);

        return new FirstName(value);
    }

    public static FirstName CreateUnsafe(string value)
    {
        value = Normalize(value);
    ...
    public static bool TryParse(string val, out FirstName result)
    {
